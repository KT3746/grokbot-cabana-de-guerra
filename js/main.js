...
import { AudioSys } from "./audio.js?v=1.2.2";
import { Input } from "./input.js?v=1.2.2";
import { Game } from "./game.js?v=1.2.2";
import { Renderer } from "./render.js?v=1.2.2";
import { bindUI } from "./ui.js?v=1.2.2";
import { bindViewport } from "./viewport.js?v=1.2.2";
